        ...
        <table class="table table-striped">
            ...
            <tbody>
                ...
                foreach ($usuarios as $usuario) {
                    ...
                    echo "<a href='../Action/asignarRol.php?id=" . $usuario->getIdUsuario() . "&rol=2' class='btn btn-secondary btn-sm'>Editor</a>";
                    echo "<a href='../Action/asignarRol.php?id=" . $usuario->getIdUsuario() . "&rol=3' class='btn btn-success btn-sm'>Usuario</a>";
                    echo "</div>";
                    echo "</td>";
                    echo "</tr>";
                }
